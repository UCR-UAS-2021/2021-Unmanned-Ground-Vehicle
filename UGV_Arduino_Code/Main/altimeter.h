...
//
//    double seaToGround; // dif from sealevel to current ground in m
//private:
//    double altimeterReturn();
//public:
//    UGVAltimeter (int csp, int sdop, int sdip, int sckp, const double sealvl = 1022.0) // Maryland = 1022
//                :   cs_pin(csp), sdo_pin(sdop),
//                    sdi_pin(sdip), sck_pin(sckp),
//                    sealvl(sealvl){
//                        this->seaToGround = bmp.readAltitude(sealvl);   // gets seaToGround;
//                    }
//    void setup();
